...
$(HARECACHE)/std/unix_tty.ssa: $(unix_tty_ha) $(HARECACHE)/std/errors.td $(HARECACHE)/std/fs.td $(HARECACHE)/std/io.td $(HARECACHE)/std/os.td $(HARECACHE)/std/os_exec.td $(HARECACHE)/std/rt.td $(HARECACHE)/std/strings.td $(HARECACHE)/std/types_c.td
	@mkdir -p -- "$(HARECACHE)/std"
